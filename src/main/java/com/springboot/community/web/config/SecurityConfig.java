package com.springboot.community.web.config;

import com.springboot.community.web.domain.enums.SocialType;
import com.springboot.community.web.oauth.ClientResources;
import com.springboot.community.web.oauth.UserTokenService;
...
import static com.springboot.community.web.domain.enums.SocialType.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .and().addFilterBefore(filter, CsrfFilter.class).addFilterBefore(oauth2Filter(), BasicAuthenticationFilter.class)
                .csrf().disable();
    }
